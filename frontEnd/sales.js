...
const tickePopupContainer = document.querySelector(".ticket");
const ticketValueContainer = document.querySelector(".ticket__value-container")
const logoComplete = "./images/logo.png";
const logoLarge = "./images/DIAMANTE.png";
