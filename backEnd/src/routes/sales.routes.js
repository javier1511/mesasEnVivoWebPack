...
router.put('/:saleId', [authJwt.verifyToken, authJwt.isUser, authJwt.isAdmin], salesController.updateSaleById);
router.get('/:saleId', [authJwt.verifyToken, authJwt.isUser, authJwt.isAdmin], salesController.getSalesById);
router.delete('/:saleId', [authJwt.verifyToken, authJwt.isUser, authJwt.isAdmin], salesController.deleteSaleById);
